        ...
        <main className="mx-auto max-w-6xl px-5 py-8 sm:px-8">
          ...
          <footer className="mt-16 border-t border-hairline pt-6 pb-4 text-center">
            ...
            <a
              ...
              className="press group mt-2.5 inline-flex items-center gap-1.5 text-[11px] font-medium tracking-wide text-faint transition-colors hover:text-accent-soft"
            >
              ...
              An <span className="font-semibold text-muted transition-colors group-hover:text-accent-soft">OuraGrove</span> product
            </a>
          </footer>
        </main>
      </div>
